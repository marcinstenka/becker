        ...
        <>
            <section className='offer'>
                <div className="offer__section1">
                    <div className="offer__developed offer__developed1 active">
                        <div className="developed__title title__border">1. Misja</div>
                        <p className="developed__text">
                        ...
                        <div onClick={() => developed('1')} className="developed__cross">
                                <span className='cross__cross1'></span>
                                <span className='cross__cross2'></span>
                        </div>
                    </div>
                    <div className="offer__developed offer__developed2">
                        <div className="developed__title">2. Uczestnicy</div>
                        <p className="developed__text">
                        ...
                        <div onClick={() => developed('2')} className="developed__cross">
                                <span className='cross__cross1'></span>
                                <span className='cross__cross2'></span>
                        </div>
                    </div>
                    ...
                    <div className="offer__section5">
                        ...
                        <div className="offer__developed offer__developed3 active">
                            <div className="developed__title title__border">1. Fizyka</div>
                            <p className="developed__text">
                            ...
                            <div onClick={() => developed('3')} className="developed__cross">
                                    <span className='cross__cross1'></span>
                                    <span className='cross__cross2'></span>
                            </div>
                        </div>
                        <div className="offer__developed offer__developed4">
                            <div className="developed__title title__border">2. Matematyka</div>
                            <p className="developed__text">
                                Osada Wiedzy opiera się na pracy wykwalifikowanych nauczycieli, z bogatym dorobkiem zawodowym, mających uprawnienia w zakresie trenerskim, pracujących i koordynujących obozy naukowe od 2010r.  Dzięki pracownikom Uniwersytetu Gdańskiego i Uniwersytetu Morskiego uczniowie będą mogli korzystać bezpośrednio z wiedzy naukowców.
                            </p>
                            <div onClick={() => developed('4')} className="developed__cross">
                                    <span className='cross__cross1'></span>
                                    <span className='cross__cross2'></span>
                            </div>
                        </div>
                        <div className="offer__developed offer__developed5">
                            <div className="developed__title title__border">3. Programowanie</div>
                            <p className="developed__text">
                            ...
                            <div onClick={() => developed('5')} className="developed__cross">
                                    <span className='cross__cross1'></span>
                                    <span className='cross__cross2'></span>
                            </div>
                        </div>
                        <div className="offer__developed offer__developed6">
                            <div className="developed__title title__border">4. Kompetencje społeczne</div>
                            <p className="developed__text">
                            ...
                            <div onClick={() => developed('6')} className="developed__cross">
                                    <span className='cross__cross1'></span>
                                    <span className='cross__cross2'></span>
                            </div>
                        </div>
                        <div className="offer__developed offer__developed7">
                            <div className="developed__title">5. Czas wolny</div>
                            <p className="developed__text">
                            ...
                            <div onClick={() => developed('7')} className="developed__cross">
                                    <span className='cross__cross1'></span>
                                    <span className='cross__cross2'></span>
                            </div>
                        </div>
